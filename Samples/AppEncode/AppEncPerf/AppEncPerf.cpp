...
void ShowHelpAndExit(const char *szBadOption = NULL)
{
    ...
    oss << "Options:" << std::endl
        ...
        << "-if          Input format: iyuv nv12 nv16 yuv444 p010 p210 yuv444p16 bgra" << std::endl
...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        ck(cuCtxCreate(&cuContext, /*ctxCreateParams*/ nullptr, CU_CTX_SCHED_BLOCKING_SYNC, cuDevice));
